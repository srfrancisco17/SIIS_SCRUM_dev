...
if ( date('n') == 12){
	...
	$this->registerCss("
		...
		h1 {position:absolute;font-size: 8.5vw;
		  width:100%;
		  height:100%;
		  text-align:center;
		  max-height:100px;
	...
	echo "<h1 class='christmas'>Feliz Navidad</h1>";
...
<div class="container">
    <div id="login-box">
        ...
        <div class="controls">
            ...
            <?= $form->field($model, 'username', $fieldOptions1)->label(false)->textInput(['autofocus' => true, 'placeholder' => 'Numero de documento']) ?>
            <?= $form->field($model, 'password', $fieldOptions2)->label(false)->passwordInput(['placeholder' => 'Contraseña']) ?>
